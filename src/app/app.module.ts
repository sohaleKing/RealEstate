import { BrowserModule } from '@angular/platform-browser';  //basics of installed angular
import { NgModule } from '@angular/core';                   //basics
...
import { AlertComponent } from './alert/alert.component';             //basics
...
@NgModule({                                                 //basics
  declarations: [                                           //basics
    AppComponent, LoginComponent, NavbarComponent, SearchComponent, ContentComponent, ListComponent, DetailComponent, RegisterComponent, PageNotFoundComponent, FooterComponent, DatabaseComponent, CartsComponent, AlertComponent                                            //basics
  ],
  imports: [                                                //basics
    BrowserModule,                                          //basics
  ...
  providers: [],                                            //basics
  bootstrap: [AppComponent]                                 //basics
})
export class AppModule { }                                  //basics
